...
export default function UsersPage() {
  ...
  async function handleSave(e) {
    ...
    // Update : on retire le mot de passe s'il est vide
    if (modal.data && !payload.password) {
  ...
  return (
    <div className="p-6">
      ...
      {notification && (
        <div className={`mb-5 rounded-2xl border px-4 py-3 text-sm ${notification.type === 'success' ? 'border-emerald-100 bg-emerald-50 text-emerald-700' : 'border-amber-100 bg-amber-50 text-amber-700'}`}>
